...
<<tbsinst,eval=FALSE>>=
install.packages("TBSSurvival_VERSION.tar.gz",repos=NULL,type="source") ## from local file
...
plot(tbs.be,ylab="R(t)",xlab="t: number of cycles (in thousands)",
     main="Reliability function (BE)",lwd=2,lty=1,col=2,lwd.HPD=2,lty.HPD=2,col.HPD=2)
lines(km)
@
